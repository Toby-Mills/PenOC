...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EventsFuture.aspx.vb" Inherits="PenOC.EventsFuture"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FutureEvents</title>
			...
			<TABLE class="ItemBackground" id="Table1" cellSpacing="0" cellPadding="1" width="100%"
				...
				<TR>
					<TD class="SectionHeader">
						<asp:Label id="Label1" runat="server">Upcoming Events</asp:Label></TD>
				</TR>
				<TR>
					<TD>
						<uc1:EventList id="EventListFuture" runat="server"></uc1:EventList></TD>
				</TR>
			</TABLE>
		</form>
	</body>
