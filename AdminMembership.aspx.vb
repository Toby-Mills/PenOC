...
#End Region
    Protected WithEvents MembershipList As MembershipList
    ...
    End Sub
    Private Sub PopulateMembershipList()
        Dim dtMembership As DataTable

        dtMembership = GetTable_Membership(c_condb, "")

        Me.MembershipList.MembershipTable = dtMembership
