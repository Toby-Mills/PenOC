<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Lookup_Venue.aspx.vb" Inherits="PenOC.Lookup_Venue"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Lookup_Venue</title>
				...
				<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD class="SectionHeader">
							<asp:Label id="Label3" runat="server" CssClass="SectionHeader">Add, Edit & Delete Venues</asp:Label></TD>
						<TD class="SectionHeader" align="right"></TD>
					</TR>
					<TR>
						<TD>
							<asp:Label id="Label4" runat="server" CssClass="text_10" Font-Bold="True">New Venue:</asp:Label></TD>
						<TD align="right"></TD>
					</TR>
					<TR>
						<TD>
							<asp:Label id="Label1" runat="server" CssClass="text_10">Name:</asp:Label>
							<asp:TextBox id="txtName" runat="server" CssClass="textbox" Width="300px"></asp:TextBox></TD>
						<TD align="right">
							<asp:Button id="cmdAdd" runat="server" CssClass="button" Text="add"></asp:Button></TD>
					</TR>
					<TR>
						<TD>
							<asp:Label id="Label5" runat="server" CssClass="text_10" Font-Bold="True">Existing Venues:</asp:Label></TD>
						<TD align="right"></TD>
					</TR>
				</TABLE>
				<asp:datagrid id="grdVenue" runat="server" CssClass="DataGrid" Width="100%" AutoGenerateColumns="False"
					...
					<Columns>
						...
						<asp:BoundColumn Visible="False" DataField="idVenue" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
